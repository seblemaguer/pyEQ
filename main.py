...
class PlotWin(QFrame):
    ...
    def mouseMoveEvent(self, e):
        ...
        if self.dragged:
            ...
            if old._type not in (
                FilterType.Peak,
                FilterType.LShelving,
                FilterType.HShelving,
            ):
                g = 0
    ...
    def updateSpectrum(self, dft):
        ...
        if dft.size > 0:
            N = dft.size
            self.speccurv.setData(
                [fs / 2 / N * i for i in range(0, N)],
    ...
    def drawTicks(self, qp, axis):
        ...
        if axis.type == "bottom":
            ...
            for tick in majors:
                ...
                qp.drawLine(self.width() - ticklen * 0.5, yp, self.width(), yp)
...
class MainWindow(QWidget):
    def __init__(self, *args):
        ...
        for i in range(0, 5):
            ...
            freq_txt.setValidator(QIntValidator(self.plotwin.xaxis.min, self.plotwin.xaxis.max, self))
